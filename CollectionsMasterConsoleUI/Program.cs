...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes we have the number you looking for");
            }
            else
            {
                Console.WriteLine($"There aren't the dordis you're looking for");
                Console.WriteLine($".....These aren't the dordis we're looking for");
            }
